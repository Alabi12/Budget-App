...
class ExpendituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expenditure" do
    assert_difference("Expenditure.count") do
      post expenditures_url, params: { expenditure: { amount: @expenditure.amount, name: @expenditure.name, user_id: @expenditure.user_id } }
    end
  ...
  test "should update expenditure" do
    patch expenditure_url(@expenditure), params: { expenditure: { amount: @expenditure.amount, name: @expenditure.name, user_id: @expenditure.user_id } }
